...
parser.add_argument('--lambda_cls_d', type=float, default=1, help='weight for domain classification loss to update D')
parser.add_argument('--lambda_cls_g', type=float, default=1, help='weight for domain classification loss to update G')
parser.add_argument('--lambda_reg', type=float, default=10, help='weight for regularization')
